                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="panel bg-teal-400">
                                        <div class="panel-body">
                                            ...
                                            <h3 class="no-margin">
                                                <label id="lblTotalMember"></label>
                                            </h3>
                                            Total referred members
											<div class="text-muted text-size-small">avg</div>
                                        </div>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="panel bg-pink-400">
                                        <div class="panel-body">
                                            ...
                                            <h3 class="no-margin"><label id="lblTotalInputData"></label></h3>
                                            Total Input Data
											<div class="text-muted text-size-small">avg/month</div>
                                        </div>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="panel bg-blue-400">
                                        <div class="panel-body">
                                            ...
                                            <h3 class="no-margin"><label id="lblTotalCorrectData"></label></h3>
                                            Total Valid Data
											<div class="text-muted text-size-small">avg</div>
                                        </div>
