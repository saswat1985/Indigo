...
namespace Effigy.DataObject.DataBase
{
    ...
    /// </summary>  
    public sealed class SqlDataAccessLayer
    {
        ...
        {
            connectionString = ConfigurationManager.ConnectionStrings["SNPLCPDBConnection"].TrimString();
        ...
        public SqlDataAccessLayer(string SbsDb)
        {
